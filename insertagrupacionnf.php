    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARfambotanica" action="recursos/acciones.php?tarea=54">
                        
                        <div class="col-md-12 titulopagina" style="margin-top: 125px;">Agrupación de Cuentas Para Notas Financieras</div>
                        <div class="col-md-12">
                            <div class="btn-group" role="group" aria-label="...">
                            <button type="button" onclick=redirigir("insertagrupacionnf.php?idempresa=<?php echo $_GET["idempresa"]; ?>") class="btn btn-default boton">Crear Nuevo Elemento +</button>
                            <button type="button" onclick=redirigir("listaragrupacionnf.php?id=<?php echo $_GET["idempresa"]; ?>")  class="btn btn-default boton">Listar Elementos</button>
                            </div>
                        </div>
