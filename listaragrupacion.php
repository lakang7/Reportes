...
<html>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARcomposicionquimica" action="recursos/acciones.php?tarea=1">
                        <div class="col-md-12 titulopagina" style="margin-top: 125px;">Agrupaciones</div>
                    ...
                    <div class="col-md-12">
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" onclick=redirigir("insertagrupacion.php?idempresa=<?php echo $_GET["id"]; ?>") class="btn btn-default boton">Crear Nuevo Elemento +</button>
                            <button type="button" onclick=redirigir("listaragrupacion.php?id=<?php echo $_GET["id"]; ?>")  class="btn btn-default boton">Listar Elementos</button>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-default">
                            <table class="table table-striped" style="font-family: 'Yanone Kaffeesatz', sans-serif; font-size: 16px;">
                                ...
                                <tbody style="border-top: 0px;">
                                    <?php
                                        $con=Conexion();
                                        $sql_listaAgrupacion="select agrupacion.idagrupacion, agrupacion.nombre as agrupa, tipoagrupacion.nombre as tipo from agrupacion, tipoagrupacion where agrupacion.idtipoagrupacion = tipoagrupacion.idtipoagrupacion and idempresa='".$_GET["id"]."' order by agrupacion.idagrupacion";
					$result_listaAgrupacion=mysql_query($sql_listaAgrupacion,$con) or die(mysql_error()); 
                                        ...
                                        if(mysql_num_rows($result_listaAgrupacion)>0){
                                            while ($fila = mysql_fetch_assoc($result_listaAgrupacion)) {
                                                ...
                                                echo "<li><a href='editaragrupacion.php?id=".$fila["idagrupacion"]."'><span class='glyphicon glyphicon-pencil' aria-hidden='true' style='margin-right: 5px;'></span>Editar</a></li>";
    ...
    <script type="text/javascript">  
        ...
        function eliminar(id){
            location.href="recursos/acciones.php?tarea=14&id="+id;
        }
    </script>     
</html>
