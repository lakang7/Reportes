...
<html>
    <head>
        ...
        <title>Generar | Reporte de Presupuesto</title>
        <script type="text/javascript" language="JavaScript" >
    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <form method="post" id="form_CREARfambotanica" action="recursos/acciones.php?tarea=50">
                        <div class="col-md-12 titulopagina" style="margin-top: 125px;">Reporte Presupuesto</div>
                        <div class="col-md-12 subtitulopagina">Generar Reporte</div>
                    
                        <div class="col-md-5 contiene_entrada" style="padding: 0px">
                        ...
                        <div class="col-md-2 contiene_entrada" style="padding: 0px; margin-left: -15px">
                            <div class="col-md-12 titulo_entrada">Opción</div>
                            <div class="col-md-12">
                            <select id="opcion" name="opcion" class="selectpicker show-tick" data-live-search="true" data-width="100%" required="required">
                                <option value="1">Visualizar</option>
                                <option value="2">Enviar por Correo</option>
                            </select>                                                        
                            </div>
                        </div>   
